...
import com.tmx.blog.api.service.ConfigService;
import com.tmx.blog.provider.dao.BlogConfigMapper;
...
public class ConfigServiceImpl implements ConfigService {
    ...
    public static final String websiteDescription = "personal blog是SpringBoot+Thymeleaf+Mybatis+dubbo+Zookeeper建造的个人博客网站";
    ...
    public static final String yourEmail = "hacfun741950370@gmail.com";
    public static final String yourName = "tmx";

    public static final String footerAbout = "personal blog. have fun.";
    public static final String footerICP = "浙ICP备 123456-7号";
    public static final String footerCopyRight = "@2020 tmx";
